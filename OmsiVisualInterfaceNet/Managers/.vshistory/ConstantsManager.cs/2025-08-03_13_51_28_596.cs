...
namespace OmsiVisualInterfaceNet.Managers
{
    public class ConstantsManager
    {
        ...
        public double? FindConstantValue(string constantName)
        {
            ...
            foreach (var file in Directory.GetFiles("E:\\SteamLibrary\\steamapps\\common\\OMSI 2\\vehicles\\Irisbus_citybus_family\\Script\\MOTEUR", "*.txt", SearchOption.AllDirectories))
            {
