...
namespace BasicCLI
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var rpm = Convert.ToInt32( omsi.Globals.PlayerVehicle.GetVariable("engine_n"));
            var speed = Convert.ToInt32(omsi.Globals.PlayerVehicle.Tacho);
            ...
            while (true)
            {
                ...
                rpm = Convert.ToInt32(omsi.Globals.PlayerVehicle.GetVariable("engine_n"));
                speed = Convert.ToInt32(playerVehicle.Tacho);
                ...
                Console.WriteLine(($"RPMs: {rpm}".PadRight(Console.WindowWidth - 1)));
                Console.WriteLine(($"Speed: {speed}".PadRight(Console.WindowWidth - 1)));
                Thread.Sleep(20);
            }
        }
