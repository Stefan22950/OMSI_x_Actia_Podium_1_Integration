...
namespace OmsiVisualInterfaceNet
{
    public class DashboardManager
    {
        ...
        {
            lastNightLightState = omsiManager.GetNightLightsState();
            ...
            {
                lastCheckEngineWarningState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_motor") < 0;
                ...
                lastDiagWarningState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_WARNING") < 0;
                lastbusStopState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_haltewunsch") < 0;
                lastSTOPState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_STOP") < 0;
                lastHighBeamState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_HighBeam") < 0;
        ...
        private void UpdateClusterLights()
        {
            ...
            bool nightLight = omsiManager.GetNightLightsState() ;
            ...
            bool lowBeam = omsiManager.GetLowBeamState();
            if (lowBeam != lastLowBeamState)
            {
                serialManager.WriteLine(lowBeam ? "LOW_BEAM_LIGHT_ON" : "LOW_BEAM_LIGHT_OFF");
