...
namespace OmsiVisualInterfaceNet
{
    public class DashboardManager
    {
            ...
            PictureBox ms_fuel)
        {
            ...
            fuelcapacity = Convert.ToDouble(GetFuelCapacityFromFile());
        ...
        public string GetFuelCapacityFromFile()
        {
            string omsiPath = @"E:\SteamLibrary\steamapps\common\OMSI 2"; // Change this to your OMSI folder
            ...
            foreach (string line in lines)
            {
                ...
                if (match.Success)
                {
                    string vehiclePath = match.Groups[1].Value.Replace("\\", "/");
                    return "Current vehicle path: " + vehiclePath;
                    
                }
            }

            return "No vehicle found in logfile.";
        }
        ...
        private void UpdateFuel()
        {
            ...
            double fuelcapacity = Convert.ToDouble(omsiManager.CurrentVehicle.GetStringVariable("engine_tank_capacity"));
            ...
            int widthfuel = (int)(8 + fuelLevel/ fuelcapacity);
