...
namespace OmsiVisualInterfaceNet
{
    public class OmsiManager : IDisposable
    {
        ...
        public void Update()
        {
            ...
            if (blinkerState != lastBlinkerState)
            {
                ...
                if (blinkerState == 1)
                    ...
                    serialManager.WriteLine("BLINKERS_OFF");
        ...
        public bool GetElectricState() => CurrentVehicle == null ? 0 : Convert.ToBoolean(CurrentVehicle.GetVariable("elec_busbar_main"));
