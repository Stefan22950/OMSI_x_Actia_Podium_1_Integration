    ...
    public class DashboardManager
    {
        ...
        public async Task HandleSerialInput(string input)
        {
            ...
            switch (input)
            {
                // Electrical system
                case "ELECTRICITY_ON":
                    await SimulatePress(v => omsiManager.SetMasterSwitch(true));
                    break;
                case "ELECTRICITY_OFF":
                    await SimulatePress(v => omsiManager.SetMasterSwitch(false));
                    break;
                ...
                case "DOOR_1_PRESSED":
                    ...
                    break;
                case "DOOR_1_RELEASED":
                    omsiManager.SetDoorButton(0, false);
                    break;
                case "DOOR_2_PRESSED":
                    omsiManager.SetDoorButton(1, true);
                    break;
                case "DOOR_2_RELEASED":
                    omsiManager.SetDoorButton(1, false);
                    break;
                case "DOOR_3_PRESSED":
                    omsiManager.SetDoorButton(2, true);
                    break;
                case "DOOR_3_RELEASED":
                    omsiManager.SetDoorButton(2, false);
                    break;
                case "AUTO_DOOR_ON":
