namespace OmsiVisualInterfaceNet.Managers
{
    public class ScreenManager
    {
        ...
        // Add new flag to track if sequence has run
        private bool hasCompletedStartupSequence = false;
                            ...
                            OmsiManager omsiManager, SerialManager serialManager)
        {
            ...
            startupTimerTicker.Interval = 1000; // 1 second
        ...
        {
            // If sequence has already completed, don't run again
        ...
        private void StartupTimerTicker_Tick(object? sender, EventArgs e)
        {
            ...
            else if (startupTimerSeconds > 12.0)
            {
                ...
                hasCompletedStartupSequence = true; // Mark sequence as completed
                return;
            }
        }
        ...
        // Add method to reset the sequence flag when needed (e.g., when power is cut)
        public void ResetStartupSequence()
        {
            hasCompletedStartupSequence = false;
            startupSequenceActive = false;
            startupTimerSeconds = 0;
            if (startupTimerTicker != null)
            {
                startupTimerTicker.Stop();
                startupTimerTicker.Dispose();
            }
