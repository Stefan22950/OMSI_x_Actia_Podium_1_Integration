...
namespace OmsiVisualInterfaceNet
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeManagers()
        {
            ...
            omsiManager = new OmsiManager(serialManager, dashboardManager, true);
            ...
            lightManager = new LightManager(omsiManager, serialManager);

            // Handle serial input for all controls
            serialManager.OnDataReceived += (input) =>
            {
                // Forward to specialized managers
                dashboardManager.HandleSerialInput(input);
                //lightManager.HandleSerialInput(input);
