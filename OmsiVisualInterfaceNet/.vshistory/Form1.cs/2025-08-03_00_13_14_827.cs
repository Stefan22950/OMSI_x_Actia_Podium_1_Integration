...
namespace OmsiVisualInterfaceNet
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            omsiManager.vehicleName = omsiManager.CurrentVehicle?.RoadVehicle?.FileName ?? "No vehicle";
        }
        ...
        private void InitializeManagers()
        {
            ...
            screenManager = new ScreenManager(StopScreen, MainScreen, LogoScreen, FuelScreen, CoolantTemperatureScreen, PressureScreen, iconPictureBoxes, omsiManager);
