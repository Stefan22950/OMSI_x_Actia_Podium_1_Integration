...
namespace OmsiVisualInterfaceNet
{
    public class OmsiManager : IDisposable
    {
        ...
        public void SetActiaScreenUp(bool pressed) => CurrentVehicle?.SetTrigger("Actia_Dash_changemode_up", true);
        public void SetActiaScreenDown(bool pressed) => CurrentVehicle?.SetTrigger("Actia_Dash_changemode_down", true);
        ...
        public void SetDoorButton(int door, bool pressed)
        {
            ...
            if (door == 0)
            {
                //CurrentVehicle?.SetTrigger(doorOpen ? "bus_doorfront0_off" : "bus_doorfront0", !doorOpen);
                CurrentVehicle?.SetVariable("cockpit_tuertaster1", doorOpen ? 0 : 1);
                //CurrentVehicle?.SetTrigger(doorOpen ? "bus_doorfront1_off" : "bus_doorfront1", !doorOpen);
                //CurrentVehicle?.SetVariable("doorTarget_1", doorOpen ? 0 : 1);
            }
            else if (door == 1)
            {
                //CurrentVehicle?.SetTrigger(doorOpen ? "bus_doorfront1_off" : "bus_doorfront1", !doorOpen);
                CurrentVehicle?.SetVariable("cockpit_tuertaster2", doorOpen ? 0 : 1);
            }else if(door == 2)
            {
                //CurrentVehicle?.SetTrigger(doorOpen ? "bus_doorfront2_off" : "bus_doorfront2", !doorOpen);
                CurrentVehicle?.SetVariable("cockpit_tuertaster3", doorOpen ? 0 : 1);
            }
