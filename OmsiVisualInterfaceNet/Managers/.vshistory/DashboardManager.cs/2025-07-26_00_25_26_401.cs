...
namespace OmsiVisualInterfaceNet
{
    public class DashboardManager
    {
        ...
        private void HandleVehicleChanged(OmsiRoadVehicleInst vehicle)
        {
            ...
            lastEngineWarningState = vehicle != null && vehicle.GetVariable("Actia_DASH_Indic_motorfailure") > 0;
            lastParkingBrakeState = vehicle != null && vehicle.GetVariable("bremse_feststell") > 0;
            lastAbsWarningState = vehicle != null && vehicle.GetVariable("bremse_ABS_eingriff") > 0;
