...
namespace OmsiVisualInterfaceNet
{
    public class DashboardManager
    {
        ...
        private readonly Panel pressure1Panel;
        private readonly Panel pressure2Panel;
            ...
            PictureBox ms_fuel)
        {
            ...
            this.pressure1Panel = pressure1Panel;
        ...
        private void UpdateCoolantTemperature()
        {
            ...
            const int maxWidth = 645;
            const double maxTemp = 120;

            coolantTemp = Math.Clamp(coolantTemp, 40, maxTemp);
            double ratio = coolantTemp / maxTemp; 
            int widthTemp = (int)(minWidth + ratio * (maxWidth - minWidth));
            coolantTempPanel.Width = widthTemp;
        ...
        private void UpdateAirPressure()
        {
            ...
            pressure1Panel.Width = widthAir1;
            ...
            pressure1Panel.Width = widthAir2;
