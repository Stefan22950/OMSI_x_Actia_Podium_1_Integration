...
namespace OmsiVisualInterfaceNet
{
    public class OmsiManager : IDisposable
    {
        ...
        public void SetStopBrake(bool on) => CurrentVehicle?.SetVariable("pressurizePin", on ? 1 : 0);
        ...
        public void SetDoorState(int door, bool open)
        {
            ...
            try
            {
                ...
                string doorVar = $"bus_doorfront{door - 1}"; // door_0, door_1, door_2 etc.

                CurrentVehicle?.SetTrigger(doorVar, open ? true : false);
