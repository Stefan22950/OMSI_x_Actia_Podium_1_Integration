...
namespace OmsiVisualInterfaceNet
{
    public class DashboardManager
    {
        ...
        private void HandleVehicleChanged(OmsiRoadVehicleInst vehicle)
        {
            ...
            lastEngineWarningState = vehicle != null && vehicle.GetVariable("Actia_DASH_Indic_motor") > 0;
            lastParkingBrakeState = vehicle != null && vehicle.GetVariable("Actia_DASH_Indic_parkingbrake") > 0;
            lastAbsWarningState = vehicle != null && vehicle.GetVariable("Actia_DASH_Indic_ABS") > 0;
            double coolantTemp = vehicle != null ? Convert.ToDouble(vehicle.GetVariable("engine_temperature")) : 0;
            lastOverheatState = coolantTemp > 100;
            double fuelLevel = vehicle != null ? Convert.ToDouble(vehicle.GetVariable("engine_tank_content")) : 0;
            lastLowFuelState = fuelLevel < 0.2;
