...
namespace OmsiVisualInterfaceNet
{
    public class DashboardManager
    {
        ...
        private bool lastBrakeWarningState;
            ...
            PictureBox ms_fuel)
        {
            ...
            {
                lastEngineWarningState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_motorfailure") > 0;
                lastBrakeWarningState = omsiManager.CurrentVehicle.GetVariable("Actia_DASH_Indic_brakefailure") > 0;
                lastParkingBrakeState = omsiManager.CurrentVehicle.GetVariable("bremse_feststell") > 0;
                lastAbsWarningState = omsiManager.CurrentVehicle.GetVariable("bremse_ABS_eingriff") > 0;
