...
namespace OmsiVisualInterfaceNet
{
    public class OmsiManager : IDisposable
    {
        ...
        public void SetLightSwitch(int pos)
        {
            ...
            {
                case 0: // Lights off
                    CurrentVehicle?.SetVariable("lights_stand", 0);
                    CurrentVehicle?.SetVariable("lights_abbl", 0);
                    break;
                case 1: // Parking lights
                    CurrentVehicle?.SetVariable("lights_stand", 1);
                    CurrentVehicle?.SetVariable("lights_abbl", 0);
                    break;
                case 2: // Low beam
                    CurrentVehicle?.SetVariable("lights_stand", 1);
                    CurrentVehicle?.SetVariable("lights_abbl", 1);
                    break;
            }
