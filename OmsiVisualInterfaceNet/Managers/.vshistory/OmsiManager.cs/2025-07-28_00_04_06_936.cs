...
namespace OmsiVisualInterfaceNet
{
    public class OmsiManager : IDisposable
    {
        ...
        public void SetDoorButton(int door, bool pressed)
        {
            ...
            {
                CurrentVehicle?.SetTrigger(doorOpen ? "bus_doorfront23_off" : "bus_doorfront23", !doorOpen);
               // CurrentVehicle?.SetVariable("doorTarget_23", doorOpen ? 0 : 1);
            }else if(door == 2)
            {
                CurrentVehicle?.SetTrigger(doorOpen ? "bus_doorfront45_off" : "bus_doorfront45", !doorOpen);
